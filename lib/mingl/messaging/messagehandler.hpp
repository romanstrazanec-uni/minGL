...
public:
    ...
    static MessageHandler onCreate(Handle handle) {
        return {WindowMessage::onCreate(), std::move(handle)};
    }

    static MessageHandler onPaint(Handle handle) {
        return {WindowMessage::onPaint(), std::move(handle)};
    }

    static MessageHandler onClose(Handle handle) {
        return {WindowMessage::onClose(), std::move(handle)};
    }

    static MessageHandler onMouseMove(Handle handle) {
